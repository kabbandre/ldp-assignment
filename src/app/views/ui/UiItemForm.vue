<template>
  <div class="query-form card">
    <div class="card-content">
      ...
      <ui-input name="title" label="Title" v-model="title" v-validate="'required'" :error="getError('title')" @enter="validate" />
      <ui-input name="description" type="textarea" label="Description" v-model="description" />
      <ui-input name="date" type="date" label="Due date" v-model="date" @enter="validate" />
      <ui-input name="priority" type="select" label="Priority" v-model="priority" />
